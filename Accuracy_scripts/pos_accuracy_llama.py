# ==============================================================================
# Unified Batched POS Tagging Evaluation — Llama-3.2-3B-Instruct
...
OUTPUT_LOGS = "pos_eval_logs_llama.jsonl"     # Changed to avoid overwriting Qwen
FIGURES_DIR = "Figures"
BATCH_SIZE  = 8   
MAX_SAMPLES = 250
    ...
    for tokens in token_lists:
        ...
        prompts.append(
            tokenizer.apply_chat_template(
                ...
                # enable_thinking=False removed for Llama compatibility
            )
        )
