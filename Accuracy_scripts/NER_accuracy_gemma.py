# ==============================================================================
# Unified NER Accuracy Evaluation — Gemma-2-2B-Instruct
...
OUTPUT_LOGS     = "ner_eval_logs_gemma.jsonl"
FIGURES_DIR     = "Figures"
RESUME          = True   
MAX_SAMPLES     = 1000     
...
def get_entity(text, script_hint):
    ...
    # Gemma does not support the 'system' role, so we combine the hint and the text
    combined_prompt = f"{hints[script_hint]}\n\nText: {text}"
